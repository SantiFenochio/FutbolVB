-- Crear tabla de canchas actualizada
...
-- Insertar datos actualizados de canchas
INSERT INTO canchas (
...
('La Calle', 'MIXTA', 8000, 8000, 12000,
 'Cancha adaptable con opción techada',
 'Perfecta para partidos íntimos con amigos',
 'Amplia y cómoda para grupos grandes',
 '10-20 jugadores', '10 jugadores', '20 jugadores',
 ARRAY['Césped sintético', 'Iluminación', 'Vestuarios'],
 ARRAY['Césped sintético', 'Iluminación', 'Vestuarios'],
 ARRAY['Césped sintético', 'Iluminación LED', 'Vestuarios', 'Techada disponible'],
 ARRAY['09:00', '10:00', '11:00', '14:00', '15:00', '16:00', '17:00', '18:00', '19:00', '20:00', '21:00', '22:00'],
 '/placeholder.svg?height=400&width=600&text=La+Calle',
 '/placeholder.svg?height=400&width=600&text=La+Calle+F5',
 '/placeholder.svg?height=400&width=600&text=La+Calle+F10'),

('El Playón', 'F10', 18000, NULL, NULL,
 'Cancha premium con las mejores instalaciones', NULL, NULL,
 '20 jugadores', NULL, NULL,
 ARRAY['Césped sintético premium', 'Iluminación LED', 'Vestuarios VIP', 'Estacionamiento', 'Tribuna', 'Sonido'], NULL, NULL,
 ARRAY['09:00', '10:00', '11:00', '14:00', '15:00', '16:00', '17:00', '18:00', '19:00', '20:00', '21:00', '22:00'],
 '/placeholder.svg?height=400&width=600&text=El+Playón+F10', NULL, NULL),

('Italia', 'F5', 9000, NULL, NULL,
 'Cancha de fútbol 5 con estilo europeo', NULL, NULL,
 '10 jugadores', NULL, NULL,
 ARRAY['Césped sintético', 'Iluminación LED', 'Vestuarios', 'Climatizada', 'Música ambiente'], NULL, NULL,
 ARRAY['09:00', '10:00', '11:00', '14:00', '15:00', '16:00', '17:00', '18:00', '19:00', '20:00', '21:00', '22:00'],
 '/placeholder.svg?height=400&width=600&text=Italia+F5', NULL, NULL);
