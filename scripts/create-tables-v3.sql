-- Crear tabla de canchas actualizada con imágenes reales
...
-- Insertar datos actualizados con imágenes reales
INSERT INTO canchas (
...
('Boulevard', 'MIXTA', 15000, 8000, 15000,
 'Cancha principal con iluminación profesional', 
 'Perfecta para partidos íntimos de fútbol 5',
 'Cancha principal con iluminación nocturna profesional',
 '10-20 jugadores', '10 jugadores', '20 jugadores',
 ARRAY['Césped sintético', 'Iluminación LED profesional', 'Vestuarios', 'Estacionamiento'],
 ARRAY['Césped sintético', 'Iluminación LED', 'Vestuarios'],
 ARRAY['Césped sintético', 'Iluminación LED profesional', 'Vestuarios', 'Estacionamiento', 'Tribuna'],
 ARRAY['09:00', '10:00', '11:00', '14:00', '15:00', '16:00', '17:00', '18:00', '19:00', '20:00', '21:00', '22:00'],
 '/images/boulevard.png',
 '/images/boulevard.png',
 '/images/boulevard.png'),

('La Calle', 'MIXTA', 8000, 8000, 12000,
 'Cancha techada amplia y luminosa',
 'Cancha techada perfecta para partidos íntimos',
 'Amplia cancha techada para grupos grandes',
 '10-20 jugadores', '10 jugadores', '20 jugadores',
 ARRAY['Techada', 'Césped sintético', 'Iluminación LED', 'Vestuarios'],
 ARRAY['Techada', 'Césped sintético', 'Iluminación LED', 'Vestuarios'],
 ARRAY['Techada', 'Césped sintético', 'Iluminación LED', 'Vestuarios', 'Climatizada'],
 ARRAY['09:00', '10:00', '11:00', '14:00', '15:00', '16:00', '17:00', '18:00', '19:00', '20:00', '21:00', '22:00'],
 '/images/la-calle.png',
 '/images/la-calle.png',
 '/images/la-calle.png'),

('El Playón', 'F10', 18000, NULL, NULL,
 'Cancha descubierta con césped sintético premium', NULL, NULL,
 '20 jugadores', NULL, NULL,
 ARRAY['Césped sintético premium', 'Descubierta', 'Vestuarios', 'Estacionamiento', 'Publicidad profesional'], NULL, NULL,
 ARRAY['09:00', '10:00', '11:00', '14:00', '15:00', '16:00', '17:00', '18:00', '19:00', '20:00', '21:00', '22:00'],
 '/images/el-playon.png', NULL, NULL),

('Italia', 'F5', 9000, NULL, NULL,
 'Cancha techada con ambiente íntimo y profesional', NULL, NULL,
 '10 jugadores', NULL, NULL,
 ARRAY['Techada', 'Césped sintético', 'Iluminación LED', 'Vestuarios', 'Ambiente íntimo'], NULL, NULL,
 ARRAY['09:00', '10:00', '11:00', '14:00', '15:00', '16:00', '17:00', '18:00', '19:00', '20:00', '21:00', '22:00'],
 '/images/italia.png', NULL, NULL);
