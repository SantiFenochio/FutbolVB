...
import { MapPin, Phone, Mail, Clock, Users, MessageCircle, Send, CheckCircle } from "lucide-react"
                ...
                <CardContent>
                  {isSubmitted ? (
                    <div className="text-center py-8">
                      ...
                      <p className="text-gray-600">Te contactaremos pronto. Gracias por tu consulta.</p>
                    </div>
                  ) : (
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="space-y-3">
                      ...
                      <p className="text-xs text-gray-500 text-center">Respuesta inmediata • Disponible 24/7</p>
                    </div>
                  </CardContent>
                </Card>
